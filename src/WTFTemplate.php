...
<html>
<head>
    <title>WTF-<?php echo $host . '-' . $error_type; ?></title>
    ...
    <style type="text/css">
        ...
        .error_line {
            font-weight: bold;
            background-color: #984245 !important;
        }
        ...
        .info {
            background: none repeat scroll 0 0 #d64e4d;
            border: 0 solid #aaa;
            color: white;
            font-size: 11pt;
            line-height: 160%;
        ...
        pre .str { color: #68c5e6 } /* string  - pink */
        pre .kwd { color: #f0e68c; font-weight: bold }
        pre .com { color: #75858c } /* comment - skyblue */
...
?>
        ...
        echo '<table cellpadding="3" cellspacing="1" width="100%" class="table"><tbody>';
        ...
        foreach ($backtrace as $k => $msg) {
            ...
            echo '<tr class="bg1">';
            echo '<td>' . $k . '</td>';
            echo '<td style="word-break: break-all">' . $msg['file'] . '</td>';
        ...
        echo '<table cellpadding="3" cellspacing="1" width="100%" class="table"><tbody>';
        echo '<tr class="bg2"><td>Key</td><td>Value</td></tr>';
        foreach ($environment as $k => $msg) {
            echo '<tr class="bg1">';
            echo '<td>' . $k . '</td>';
            echo '<td style="word-break: break-all">' . $msg . '</td>';
            echo '</tr>';
        }
        echo "</tbody></table></div>";
...
echo '</div><div style="text-align: center">time: ' . date('Y-m-d H:i:s') . '</div></body>';?>
        <script>
            ;(function(){
                prettyPrint();
